  ...
  return (
    <NoSsr>
      <div className="mt-14 flex border-b border-white/10 px-4 md:mt-16 md:border-none lg:px-0">
        <div className="mx-auto flex w-full max-w-7xl items-center lg:px-1">
          <button
          ...
          >
            <ChevronLeftIcon className="mr-0.5 h-5 w-5 text-amber-400/40" />
            Back to Projects
          </button>
        </div>
      </div>
      <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-28 lg:px-3 lg:pt-10">
        <div className="grid grid-cols-1 items-center gap-y-16 gap-x-4 lg:grid-cols-3">
          <div className="flex flex-col">
            ...
            <div className="mt-7 grid w-fit grid-cols-3 gap-y-6 gap-x-7">
            ...
            <div className="mt-12 flex max-w-2xl items-center gap-4 lg:mt-14">
              <button className="inline-flex w-1/2 justify-center rounded-md bg-amber-500/60 py-4 text-zinc-100 transition-colors hover:bg-amber-500 md:rounded-lg">
              ...
              <button className="inline-flex w-1/2 justify-center rounded-md border border-amber-500/60 py-4 text-zinc-200 transition-colors hover:border-amber-500 hover:text-zinc-100 md:rounded-lg md:px-8">
                <span className="flex items-center">
                  Source code
                  <svg
                    viewBox="0 0 24 24"
          ...
          <div className="relative mt-8 lg:col-span-2 lg:mr-1 lg:ml-20 lg:mt-0">
            <ImageSlider images={project?.screenshots} />
            <div className="z-0 hidden md:block">
              <div className="absolute -bottom-28 flex h-8 items-end overflow-hidden">
                <div className="-mb-px flex h-[2px] w-96 -scale-x-100">
      ...
      <div className="mx-auto mb-20 max-w-7xl px-6 lg:mb-16 lg:mt-20 lg:px-3">
        <div className="flex flex-col space-y-10 lg:flex-row lg:space-y-0 lg:space-x-20">
          <section className="-mt-6 w-full md:mt-6">
            <div className="mb-6 md:mb-8">
              <h2 className="text-3xl font-semibold text-zinc-200">Features</h2>
            </div>

  ...
  return (
    <NoSsr>
      ...
      <div className="mx-auto flex max-w-7xl flex-col-reverse px-2 pb-24 lg:flex-row">
        <div className="w-full py-6 px-4 lg:w-[64%] lg:px-2">
          <Prose content={post?.content} />
        </div>
        <div className="hidden h-auto w-px flex-col bg-white/5 md:ml-12 lg:flex xl:ml-14"></div>
        <div className="-mt-4 mb-4 flex flex-col gap-y-4 border-b border-white/10 px-4 pb-6 md:border-none md:pt-8 lg:ml-10 lg:mt-0 lg:px-0">

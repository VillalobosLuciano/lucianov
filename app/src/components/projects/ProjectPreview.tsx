...
export default function ProjectPreview({
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative mt-4 transform cursor-pointer overflow-hidden rounded-2xl bg-zinc-900/10 px-4 pt-5 pb-4 ring-1 ring-white/10 backdrop-blur transition-colors duration-200 hover:bg-zinc-900/20 hover:ring-amber-500/20"
    >

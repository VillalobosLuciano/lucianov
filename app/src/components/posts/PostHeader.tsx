  ...
  return (
    <>
      <div className="mt-16 mb-2 space-y-3 md:mt-8">
        <h1 className="md:leading-11 max-w-4xl pt-1 font-display font-semibold capitalize leading-9 tracking-tight text-zinc-600 dark:text-zinc-300 sm:text-4xl sm:leading-10 md:text-5xl">
          {title}
        </h1>
